...
1) Вызвать миграционный файл ./schema/000001_init.up.sql - `migrate -path ./schema -database 'postgres://postgres:postgres@localhost:5434/postgres?sslmode=disable' up` (предварительно скачать пакеты(для мака) `brew install golang-migrate`)
